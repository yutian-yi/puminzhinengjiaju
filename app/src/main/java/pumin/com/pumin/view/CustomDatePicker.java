...
public class CustomDatePicker {
    private TextView year_TX,month_TX,day_TX;
    ...
    private void initView() {
        ...
        year_TX = (TextView) datePickerDialog.findViewById(R.id.year_TX);
        month_TX = (TextView) datePickerDialog.findViewById(R.id.month_TX);
        day_TX = (TextView) datePickerDialog.findViewById(R.id.day_TX);
    ...
    public void showSpecificTime1(boolean show) {
        if (canAccess) {
            if (show) {
                disScrollUnit();//year_pv, month_pv, day_pv
                year_pv.setVisibility(View.VISIBLE);
                year_TX.setVisibility(View.VISIBLE);
                month_pv.setVisibility(View.VISIBLE);
                month_TX.setVisibility(View.VISIBLE);
                day_pv.setVisibility(View.VISIBLE);
                day_TX.setVisibility(View.VISIBLE);
            } else {
//                disScrollUnit(SCROLL_TYPE.HOUR, SCROLL_TYPE.MINUTE);
                year_pv.setVisibility(View.GONE);
                year_TX.setVisibility(View.GONE);
                month_pv.setVisibility(View.GONE);
                month_TX.setVisibility(View.GONE);
                day_pv.setVisibility(View.GONE);
                day_TX.setVisibility(View.GONE);
            }
        }
    }
    /**
